    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        var auctions = new List<Auction>()
        {
            ...
            new Auction
            {
                ...
                ReservePrice = 90000,
                Seller = "alice",
                AuctionEnd = DateTime.Now.AddDays(60),
                Item = new Item
                {
                    Make = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEnd = DateTime.Now.AddDays(4),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Mustang",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTime.Now.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                AuctionEnd = DateTime.Now.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEnd = DateTime.Now.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                AuctionEnd = DateTime.Now.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTime.Now.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
